...
export default function ContactsHeader({
    ...
    return (
        <div className='table-controls contact-controls'>
            <GlobalSearchInput value={globalSearch} onChange={(e) => onGlobalSearchChange(e.target.value)} />
            <Button
            ...
            />
            <ControlButton variant={BUTTON_VARIANTS.NEW} tooltip='Add new contact' onClick={onCreateContact} />
            <ControlButton
